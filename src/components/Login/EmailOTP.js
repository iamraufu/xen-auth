      ...
      return (
            <div className="auth">
                  <div className="position-absolute top-50 start-50 translate-middle">
                        ...
                        <Link className='text-decoration-none' style={{ color: 'black' }} to='/phone-otp'><p className='forgot-password p-2 fw-bold text-center'><i class="fas fa-mobile-alt"></i> Send OTP to my phone</p></Link>
